...
async function enhancedPredict(student, studentGrades, type, userRole = 'admin') {
  ...
  return {
    ...
    recommendations,
    feature_importance,
    category_contributions: overallRisk.categoryContributions,
    categorizedRisk: {
      financial,
      personal,
      academic,
...
export default function PredictionPage({ departmentFilter, courseFilter }) {
  ...
  const predictMutation = useMutation({
    mutationFn: async () => {
      ...
      const prediction = await enhancedPredict(student, studentGrades, predictionType, 'admin');
