...
async function enhancedPredict(student, studentGrades, type, userRole = 'dean') {
...
export default function DeanPredictions() {
  ...
  const predictMutation = useMutation({
    mutationFn: async () => {
      ...
      const prediction = await enhancedPredict(student, studentGrades, predictionType, 'dean');
